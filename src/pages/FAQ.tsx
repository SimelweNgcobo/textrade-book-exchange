  ...
  const faqItems = [
    {
      ...
      answer: "ReBooked Solutions is a platform where individuals can buy and sell second-hand or new books. It provides a safe and accessible environment for book lovers to exchange books."
    },
    {
      question: "How much will I earn when I sell my book?",
      answer: "Sellers keep 90% of the sale price. ReBooked Solutions takes a 10% commission to help maintain and improve the platform."
    },
    {
      question: "Does ReBooked Solutions buy books?",
      answer: "No, ReBooked Solutions does not directly purchase books. We provide an environment where people can sell their books to other individuals."
    },
    {
    ...
    {
      question: "What kinds of books can I sell on ReBooked Solutions?",
    ...
    },
    {
      ...
      answer: "If there's a problem—like a missing delivery or damaged book—you can contact ReBooked Solutions support for help. We aim to keep the platform safe and fair."
    },
    {
    ...
    {
      question: "Is ReBooked Solutions available outside of South Africa?",
      answer: "Currently, ReBooked Solutions is focused on serving users within South Africa."
    }
  ];
